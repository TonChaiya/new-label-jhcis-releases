...
## การคืนสถานะ Visit หลังพิมพ์

- เมื่อฉลากพิมพ์สำเร็จ ระบบจะพยายามเปลี่ยน `flagservice` ของ Visit นั้นจาก `Z1` หรือ `Y1` เป็น `03` ทันที
- หากผู้ใช้บันทึกหน้าจอ JHCIS เดิมทับกลับเป็น Z1/Y1 ภายหลัง ให้กำหนดช่วงเวลา “เคลียร์คิวอัตโนมัติหลังพิมพ์” ที่หน้า Cleanup ระบบจะตรวจซ้ำเฉพาะ Visit ที่มีหลักฐานว่าพิมพ์สำเร็จแล้ว
- การตรวจซ้ำไม่ใช่คำสั่งเคลียร์ทุกคิวใน JHCIS; ปุ่ม “เคลียร์คิวตกค้าง Z1/Y1” แบบเดิมยังเป็นคำสั่งแมนนวลแยกต่างหากและต้องยืนยันรหัสผ่าน
